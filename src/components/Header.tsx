          ...
          {siteConfig.nav.map((item) => {
            ...
            return (
              <Link
                ...
                className={
                  active
                    ? 'border-b-2 border-primary pb-1 font-bold tracking-wide text-primary'
                    : 'font-bold tracking-wide text-on-surface transition-colors duration-200 hover:text-primary'
                }
              >
                {item.label}
              </Link>
